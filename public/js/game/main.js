...
const   /* Canvas 1 */ board_width = 10,    board_height = 20,
        /* Canvas 2 */ next_width = 5,      next_height = 5,
        /* Canvas 3 */ saved_width = 5,     saved_height = 5,
        /* Canvas 4 */ score_width = 15.5,  score_height = 1
...
/* ----------------- GLOBALES: FIGURAS ------------------ */
var board
var player, saved_figure, next_figure
var allow_save_mode = true
var display_nav = document.getElementById("navigator")



/* --------------- GLOBALES: JUGABILIDAD ---------------- */
const score_per_row = 100
var score_to_level_up
var score
var lvl, initial_level_selected
var interval, paused
